...
ui <- navbarPage(
  ...
  tabPanel("Home",
           fluidPage(
            ...
            h2("Data"),
            p("To determine the quality of Massachusetts public schools, I first collected a ",
              "data set of each school's performance on the MCAS in all possible grade levels. ",
              "I merged this data set with data sets containing other information about schools ",
              "to find relationships between test scores and other factors. In particular, ",
              "I looked at demographic information --- who are the students in a school ---",
              "and organizational information --- qualities such as spending and teacher salaries.",
